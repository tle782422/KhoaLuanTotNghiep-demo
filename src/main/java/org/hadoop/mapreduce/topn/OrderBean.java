...
public class OrderBean implements WritableComparable<OrderBean>,Serializable {
	...
	public int compareTo(OrderBean o) {
	    Float tmp = o.getAmountFee() - this.amountFee;
	    if (tmp == 0) {
	        // Nếu amountFee bằng nhau, sắp xếp theo productName tăng dần
	        return this.productName.compareTo(o.getProductName());    
	    } else if(tmp > 0) {
	    	// Sắp xếp theo amountFee giảm dần
	        return 1;
	    } else {
	    	return -1;
	    }
//	    return Float.compare(o.getAmountFee(), this.getAmountFee())==0?this.productName.compareTo(o.getProductName()):Float.compare(o.getAmountFee(), this.getAmountFee());
	}
}
